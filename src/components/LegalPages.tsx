...
export const PrivacyPolicy = () => (
  <LegalPage title="מדיניות פרטיות">
    <p className="text-white/30 text-xs">עדכון אחרון: מרץ 2026</p>
    <h2 className="text-base font-bold text-white">1. כללי</h2>
    ...
    <h2 className="text-base font-bold text-white">2. מידע שאנו אוספים</h2>
    ...
    <h2 className="text-base font-bold text-white">3. מטרות</h2>
    ...
    <h2 className="text-base font-bold text-white">4. שיתוף מידע</h2>
    ...
    <h2 className="text-base font-bold text-white">5. אבטחת מידע</h2>
    ...
    <h2 className="text-base font-bold text-white">6. זכויותיך</h2>
...
export const TermsOfUse = () => (
  <LegalPage title="תנאי שימוש">
    ...
    <h2 className="text-base font-bold text-white">2. המוצר</h2>
    ...
    <h2 className="text-base font-bold text-white">3. תאימות</h2>
    ...
    <h2 className="text-base font-bold text-white">4. מחירים ותשלום</h2>
    ...
    <h2 className="text-base font-bold text-white">5. אספקה ומשלוח</h2>
    ...
    <h2 className="text-base font-bold text-white">6. הגבלת אחריות</h2>
    ...
    <h2 className="text-base font-bold text-white">7. קניין רוחני</h2>
    <p>כל התכנים באתר, לרבות טקסטים, תמונות, עיצוב ולוגו, הם רכוש החברה ומוגנים בזכויות יוצרים.</p>
    <h2 className="text-base font-bold text-white">8. דין חל וסמכות שיפוט</h2>
    <p>על תנאים אלו יחולו חוקי מדינת ישראל. סמכות השיפוט הבלעדית נתונה לבתי המשפט במחוז המרכז.</p>
    <p>לשאלות: <a href="mailto:support@d10.store" className="text-blue-300 underline">support@d10.store</a></p>
  </LegalPage>
);

export const AccessibilityStatement = () => (
  <LegalPage title="הצהרת נגישות">
    <p className="text-white/30 text-xs">עדכון אחרון: מאי 2026</p>
    ...
    <h2 className="text-base font-bold text-white">כלי נגישות באתר</h2>
    ...
    <ul className="list-disc pr-6 space-y-1">
      <li>דוא"ל: <a href="mailto:support@d10.store" className="text-blue-300 underline">support@d10.store</a></li>
...
export const ReturnsCancellationPolicy = () => (
  <LegalPage title="ביטולים והחזרות">
    ...
    <h2 className="text-base font-bold text-white">זכות ביטול</h2>
    ...
    <h2 className="text-base font-bold text-white">אופן הביטול</h2>
    <ul className="list-disc pr-6 space-y-1">
      <li>באמצעות פנייה בדוא"ל: <a href="mailto:support@d10.store" className="text-blue-300 underline">support@d10.store</a></li>
      <li>באמצעות פנייה טלפונית או בכתב</li>
    </ul>

    <h2 className="text-base font-bold text-white">דמי ביטול</h2>
    ...
    <h2 className="text-base font-bold text-white">תנאים להחזרת המוצר</h2>
    <ul className="list-disc pr-6 space-y-1">
    ...
    <h2 className="text-base font-bold text-white">החזר כספי</h2>
    <p>ההחזר יתבצע באמצעי התשלום המקורי, <strong>תוך 14 ימים ממועד קבלת הודעת הביטול</strong>.</p>

    <h2 className="text-base font-bold text-white">מוצר פגום / אי-התאמה</h2>
    ...
    <p><a href="mailto:support@d10.store" className="text-blue-300 underline">support@d10.store</a></p>

    <h2 className="text-base font-bold text-white">אחריות</h2>
